                            ...
                            <form noValidate className="space-y-6 mt-10" onSubmit={formik.handleSubmit}>
                                <div className="space-y-1 text-sm flex justify-between items-center">
                                    ...
                                    <input
                                        ...
                                        name="hoTen"
                                        id="name"
                                        placeholder="Name" className="w-full px-4 py-3 rounded-md sm:text-sm focus:border focus:border-gray-300 outline-none"
                                        value={formik.values.hoTen}
                                        onChange={formik.handleChange} />
                                </div>
                                <div className="space-y-1 text-sm flex justify-between items-center">
                                    <label htmlFor="email" className="block">Email:</label>
                                    <input type="text" name="email" id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md sm:text-sm focus:border focus:border-gray-300 outline-none"
                                        value={formik.values.email}
                                        onChange={formik.handleChange} />
                                </div>
                                <div className="space-y-1 text-sm flex justify-between items-center">
                                    <label htmlFor="phone" className="block ">Phone:</label>
                                    <input type="text" name="soDt" id="phone" placeholder="Phone" className="w-full px-4 py-3 rounded-md sm:text-sm focus:border focus:border-gray-300 outline-none"
                                        value={formik.values.soDt ? formik.values.soDt : ''}
                                        onChange={formik.handleChange} />
                                </div>
                                <div className="space-y-1 text-sm flex justify-between items-center">
                                    <label htmlFor="username" className="block">Username:</label>
                                    <input type="text" name="taiKhoan" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md sm:text-sm focus:border focus:border-gray-300 outline-none"
                                        value={formik.values.taiKhoan}
                                        onChange={formik.handleChange} />
                                </div>
                                <div className="space-y-1 text-sm flex justify-between items-center">
                                    <label htmlFor="password" className="block">Password:</label>
                                    <input type="password" name="matKhau" id="password" className="w-full px-4 py-3 rounded-md sm:text-sm focus:border focus:border-gray-300 outline-none"
                                        value={formik.values.matKhau}
                                        onChange={formik.handleChange} />

                                </div>

                                <button type="submit" className="block w-full p-3 text-center rounded-sm text-white text-xl bg-violet-600 bg-opacity-40 hover:bg-opacity-90">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
