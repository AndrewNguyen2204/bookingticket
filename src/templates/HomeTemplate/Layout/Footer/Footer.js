        ...
        <footer className="footer relative py-6 bg-black text-white" >
            ...
            <div className="px-6 space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50 rounded-xl p-4">
                <div className="grid grid-cols-12 gap-2">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 mb-2 text-lg text-center font-medium">Mobile Apps</p>
                        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 lg:ml-0 lg:mt-0">
                            <Button buttonStyle="btn--outline" size="btn--small">
                ...
                <div className="grid justify-center p-3 lg:justify-between glass rounded-full">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                        <NavLink to="/home" className="flex items-center justify-center w-10 h-10 rounded-full bg-mainColor text-coolGray-50">
