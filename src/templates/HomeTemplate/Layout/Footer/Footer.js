        ...
        <footer className="footer" >
            ...
            <div className="footer-wrapper">
                <div className="footer-content ">
                    ...
                    <div className="footer-content--partners">
                        <p>Partners</p>
                        <div className="partner-wrapper">
                            {renderPartners()}
                        </div>
                    </div>
                    <div className="footer-content--apps">
                        <p>Mobile Apps</p>
                        ...
                        <div className="button-wrapper">
                            <button>
                                ...
                                <span className="flex flex-col items-start ml-4 leading-none">
                                    <span className="mb-1 text-[10px]">GET IT ON</span>
                            ...
                            <button>
                                ...
                                <span className="flex flex-col items-start ml-4 leading-none">
                                    <span className="mb-1 text-[10px]">Download on the</span>
                ...
                <div className="grid justify-center p-3 lg:justify-between glass rounded-full">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                        <NavLink to="/home" className="glass flex items-center justify-center w-10 h-10 rounded-full text-mainColor">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                            </svg>
                        </NavLink>
                        <NavLink to="/home" className="flex items-center justify-center w-10 h-10 rounded-full glass text-mainColor">
